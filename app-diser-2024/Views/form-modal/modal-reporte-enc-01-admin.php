<!-- Modal -->
<div class="modal fade" id="modal-form-enc-01-admin" tabindex="-1" role="dialog" aria-labelledby="exampleModalSignTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-primary text-gradient">ENC-01: ACEPTABILIDAD DE LOS ALIMENTOS DE PNAEQW</h3>
                    ...
                    <div class="card-body card-color-pastel pb-3">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-sm" id="tbl-reporte-enc-01">
